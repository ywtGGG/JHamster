...
//        sqlSessionFactoryBean.setMapperLocations(resolver.getResources("classpath:com/ywt/rocketmq/dal/**/*.xml"));
//        sqlSessionFactoryBean.setConfigLocation(resolver.getResource("classpath:META-INF/mybatis/configuration.xml"));
//        sqlSessionFactoryBean.setTypeAliasesPackage("com.ywt.rocketmq.entity.model");
